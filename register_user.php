...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $objects = [
            ['url_img' => 'snakePFP.png', 'nombre' => 'Icon', 'precio' => 2000, 'id_juego' => 0, 'comprado' => 0],
            ['url_img' => 'tetrisPFP.png', 'nombre' => 'Icon', 'precio' => 2000, 'id_juego' => 0, 'comprado' => 0],
            ['url_img' => 'pongPFP.png', 'nombre' => 'Icon', 'precio' => 2000, 'id_juego' => 0, 'comprado' => 0],
            ['url_img' => 'galagaPFP.png', 'nombre' => 'Icon', 'precio' => 2000, 'id_juego' => 0, 'comprado' => 0],
            ['url_img' => 'snakeBG2.png', 'nombre' => 'Snake fondo rojo', 'precio' => 500, 'id_juego' => 1, 'comprado' => 0], 
            ['url_img' => 'snakeBG3.png', 'nombre' => 'Snake fondo verde', 'precio' => 500, 'id_juego' => 1, 'comprado' => 0], 
        ];
